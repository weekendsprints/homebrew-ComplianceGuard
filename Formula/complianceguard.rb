...
class Complianceguard < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/weekendsprints/ComplianceGuard/releases/download/v0.0.2/complianceguard-darwin-arm64.tar.gz"
      sha256 "cca6f626112dd8d70ea431a29de62ae18e251d428bbde4d32ee8649d57fb9f75"
    else
      url "https://github.com/weekendsprints/ComplianceGuard/releases/download/v0.0.2/complianceguard-darwin-amd64.tar.gz"
  ...
  on_linux do
    if Hardware::CPU.arm?
      url "https://github.com/weekendsprints/ComplianceGuard/releases/download/v0.0.2/complianceguard-linux-arm64.tar.gz"
      sha256 "6250edd25a0c8088d548ccb9ea07f6fc3d78c924a9c23fdffe2458cc1d71166f"
    else
      url "https://github.com/weekendsprints/ComplianceGuard/releases/download/v0.0.2/complianceguard-linux-amd64.tar.gz"
